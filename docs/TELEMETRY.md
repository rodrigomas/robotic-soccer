...
dashboard field overlays, timeline, and heatmap views.
...
The next slice should add overlay toggles for pass lanes and pressure so the
field focus can isolate one tactical layer at a time.
