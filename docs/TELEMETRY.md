...
passes, shots, and possession changes. The heatmap view can filter the same grid
by team, entity type, and individual player, and it shows movement metrics plus
...
The next slice should add team filters to the replay timeline.
