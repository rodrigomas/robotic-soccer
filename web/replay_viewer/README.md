...
can toggle pass-lane, pressure, and selected-shot path overlays independently,
...
ball velocity to the target goal line. Timeline clicks or keyboard navigation
highlight matching field context with raw selected-event and shot-specific
detail panels.
